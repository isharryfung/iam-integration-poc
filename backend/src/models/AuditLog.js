...
const auditLogSchema = new mongoose.Schema(
  {
    ...
    action: {
      ...
      enum: [
        ...
        'list_iam_users', 'get_iam_user', 'update_iam_user_permissions', 'get_reporting_line',
        'query_midpoint_preview', 'query_midpoint_preview_by_email', 'query_midpoint_events',
        'resolve_approvers',
      ],
      required: true,
    },
